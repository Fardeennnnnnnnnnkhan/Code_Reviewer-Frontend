  ...
  return (
    <section className="w-full mx-auto px-4 md:px-12 py-24 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-lg md:text-xl text-gray-500 mb-10 max-w-2xl mx-auto">
        Schedule a quick call to learn how CodeCureAI can turn your workflow
        into a powerful advantage.
      </p>
      <button className="w-full max-w-3xl bg-[#4a5d13] text-white font-semibold text-lg md:text-xl py-5 rounded-full mb-20 hover:bg-[#37470e] transition">
        Learn More
      ...
      <footer className="w-full flex flex-col gap-4 md:gap-0 md:flex-row md:items-end md:justify-between px-2 md:px-0 pb-4">
        ...
        <div className="text-[#8e9c78] text-sm font-mono mt-2 md:mt-0">
          
        </div>
        
      </footer>
      <div className="w-full text-center text-gray-400 text-lg mt-2 ">
        Created and developed by <span className="text-[#8e9c78] font-mono font-bold"> Fardeen Khan</span>
      </div>
    </section>
  );
}
